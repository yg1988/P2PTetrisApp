...
import com.example.android.wifidirect.discovery.WiFiChatFragment.tickAndSet1;
...
public class WiFiServiceDiscoveryActivity extends Activity implements
    ...
    public boolean handleMessage(Message msg) {
        ...
        case MESSAGE_READ:
            ...
            chatFragment.t2.setText(readMessage);
            break;
    ...
    public void moveLeft(View view) {
		new tickAndSet1().execute(JTetris.LEFT);
	}

	public void moveRight(View view) {
		new tickAndSet1().execute(JTetris.RIGHT);
	}
	...
	public void rotate(View view) {
		new tickAndSet1().execute(JTetris.ROTATE);
	}
    class tickAndSet1 extends AsyncTask<Integer , Void, Void>{
		...
		protected void onPostExecute(Void result) {
			...
			chatFragment.t.setText(chatFragment.tetris.paintComponent());
		}
